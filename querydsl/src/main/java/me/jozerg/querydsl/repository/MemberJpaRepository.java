...
public class MemberJpaRepository {
    ...
    // 1. where 조건에 BooleanExpression을 사용하면 재사용이 가능하기 때문에 권장.
    // 2. 조합이 가능(이것도 재사용이긴 하지??)
...
//                        ageLoe(condition.getAgeLoe())
    ...
    // null check를 보완해야겠지만 이것도 가능
    private BooleanExpression ageBetween(int ageLoe, int ageGoe) {
        return ageLoe(ageLoe).and(ageGoe(ageGoe));
    }

    // Predicate 보다 BooleanExpression이 좋음
    // 왜냐하면 BooleanExpression은 Conposite 조합이 가능하기 때문
